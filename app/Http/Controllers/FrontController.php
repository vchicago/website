...
class FrontController extends Controller
{
    ...
    public function staffRequest(Request $request) {
	    ...
	    public function showPilotDash() {
			return view('site.pilots.dashboard');
    }
	    public function showRunways()
    {
        $kord = Weather::find('KORD');
        $kmdw = Weather::find('KMDW');
        $kmke = Weather::find('KMKE');

        return View::make('site.runways')->with('kord', $kord)->with('kmdw', $kmdw)->with('kmke', $kmke);
    }
}
