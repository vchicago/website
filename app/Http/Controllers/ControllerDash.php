...
class ControllerDash extends Controller
{
    ...
    public function showDiscord() {
        return view('dashboard.controllers.discord');
    }
    ...
    public function showRoster() {
        ...
        return view('dashboard.controllers.roster')->with('hcontrollers', $hcontrollers)->with('vcontrollers', $vcontrollers)->with('loacontrollers', $loacontrollers);
    }
    ...
    public function reportBug(Request $request) {
        ...
        return view('dashboard.controllers.staff')->with('atm', $atm)->with('datm', $datm)
