...
@section('content')
<div class="container">
<h1 class="h3 mb-4 text-gray-800">Training Tickets</h1>
</div>
<br>
...
<div class="container">
	...
	<br>
	<br>
<center><p class="text-xs text-gray-600">*Training tickets imported from the old zau website are labled 'Imported Ticket' and may not contain the full training info.</p></center>
</div>
