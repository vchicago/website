	...
	<div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                      <div class="h3 mb-0 font-weight-bold text-gray-600">Controller Statistics</div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="card bg-primary">
                <br>
                <center><h4 class="text-gray-200">{{ number_format($all_stats['month'], 2) }}</h4></center>
                <br>
            </div>
        </div>
        <div class="col-sm-4">
            ...
            <div class="card bg-primary">
                <br>
                <center><h4 class="text-gray-200">{{ number_format($all_stats['year'], 2) }}</h4></center>
                <br>
            </div>
        </div>
        <div class="col-sm-4">
            ...
            <div class="card bg-primary">
                <br>
                <center><h4 class="text-gray-200">{{ number_format($all_stats['total'], 2) }}</h4></center>
                <br>
            </div>
        </div>
    </div>
