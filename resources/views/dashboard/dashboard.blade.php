...
<div class="container">
    ...
    <hr>
    <center>
        <h5 class="text-primary">Flights Currently Within ZAU Airspace</h5>
    </center>
    <div class="table-responsive">
    ...
    <hr>
    <center>
        <h2><i class="fa fa-microphone" style="color:#C9AE5D"></i> Bronze Mic Award <i class="fa fa-microphone" style="color:#C9AE5D"></i></h2>
    </center>
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <center>
                        <h4>Most Recent Winner ({{ $month_words }})</h4>
                    </center>
                    <div class="card card-body" style="border-color:#C9AE5D">
                        @if($winner != null)
                        <center>
                        ...
                        @else
                        <center>
                            <h4>No Winner Has Been Chosen</h4>
                        </center>
                        <center>
                            <h5>Check back for updates!</h5>
                        </center>
    ...
    <hr>
    <center>
        <h2><i class="fa fa-microphone" style="color:#FFDF00"></i> Pyrite Mic Award for 20{{ $lyear }} <i class="fa fa-microphone" style="color:#FFDF00"></i></h2>
    </center>
    <div class="row">
        <div class="col-sm-4">
        </div>
