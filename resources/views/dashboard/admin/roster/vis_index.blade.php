...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Visit Requests</h1>
    </div>
<br>
<div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span data-toggle="modal" data-target="#reject{{ $v->id }}">
                                        <button type="button" class="btn btn-danger simple-tooltip" data-placement="top" data-toggle="tooltip" title="Reject"><i class="fa fa-thumbs-down"></i></button>
                                    </span>
                                        <a href="/dashboard/admin/roster/visit/delete/{{ $v->id }}" class="btn btn-danger simple-tooltip" data-toggle="tooltip" title="Delete"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
