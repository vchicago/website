...
@section('content')
    <div class="container">
        <h1 class="h3 mb-4 text-gray-800">Scenery Management</h1>
    </div>
<br>
<div class="container">
                    ...
                    <thead>
                        ...
                        @foreach($fsx as $s)
                            <tr>
                                <td>
                                    @if($s->image1)
                                        <a href="/dashboard/admin/scenery/view/{{ $s->id }}"><img src="{{ $s->image1 }}" width="200px"></img></a>
                                    @else
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg" width="200px"></img>
                                    @endif
                                </td>
                                <td>{{ $s->airport }}</td>
                                <td>
