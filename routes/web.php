...
Route::get('/pilots/', 'FrontController@showPilotDash');
...
Route::get("joke", "FrontController@getJoke");
...
Route::prefix('dashboard')->middleware('auth')->group(function() {
    ...
    Route::prefix('controllers')->group(function() {
        ...
        Route::get('/discord', 'ControllerDash@showDiscord');
		...
		Route::get('/staff', 'ControllerDash@showStaff');
    ...
    Route::prefix('admin')->group(function() {
        ...
        Route::prefix('calendar')->middleware('permission:staff')->group(function() {
            ...
            Route::post('/edit/vis/{id}', 'AdminDash@toggleCalendarEventVisibilty');
        });
        ...
        Route::prefix('roster')->middleware('permission:roster')->group(function() {
			...
			Route::get('/visit/delete/{id}', 'AdminDash@deleteVisitRequest');
